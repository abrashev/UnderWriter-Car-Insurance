...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { datecalculated: @quotation.datecalculated, identification: @quotation.identification, quotepremium: @quotation.quotepremium }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { datecalculated: @quotation.datecalculated, identification: @quotation.identification, quotepremium: @quotation.quotepremium }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
